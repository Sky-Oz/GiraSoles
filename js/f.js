...
const animacionPetalo1 = [
    ...
    { transform: "rotateZ(270deg)", left: "20%", top: "30%", background:"linear-gradient(to top, #d15b01, #fdc300, #fdc300)",offset: 0.75},
...
const animacionPetalo2 = [
    ...
    { transform: "rotateZ(270deg)", left: "20%", top: "15%", background:"linear-gradient(to top, #d15b01, #fdc300, #fdc300)",offset: 0.75},
...
const animacionPetalo3 = [
    ...
    { transform: "rotateZ(270deg)", left: "47%", top: "30%", background:"linear-gradient(to top, #d15b01, #fdc300, #fdc300)",offset: 0.75},
...
const animacionPetalo4 = [
    ...
    { transform: "rotateZ(270deg)", left: "47%", top: "15%", background:"linear-gradient(to top, #d15b01, #fdc300, #fdc300)",offset: 0.75},
...
const animacionPetalo5 = [
    ...
    { transform: "rotateZ(270deg)", left: "14%", top: "23%", background:"linear-gradient(to top, #d15b01, #fdc300, #fdc300)",offset: 0.75},
...
const animacionPetalo6 = [
    ...
    { transform: "rotateZ(270deg)", left: "32.7%", top: "12%", background:"linear-gradient(to top, #d15b01, #fdc300, #fdc300)",offset: 0.75},
...
const animacionPetalo7 = [
    ...
    { transform: "rotateZ(270deg)", left: "52%", top: "23%", background:"linear-gradient(to top, #d15b01, #fdc300, #fdc300)",offset: 0.75},
...
const animacionPetalo8 = [
    ...
    { transform: "rotateZ(270deg)", left: "33.4%", top: "34%", background:"linear-gradient(to top, #d15b01, #fdc300, #fdc300)",offset: 0.75},
...
function iniciar(){
    ...
    elementoCentro.addEventListener("mousemove",giralGirasol); 
}
function giralGirasol(evento){
